...
2026-06-16。图在原网页。OpenRouter DRACO 分数是**他们的表**，不是 vLLM-SR 评测。MoM 总论见 [new chapter](semantic-router-mom.md)；Looper 全家见 [Micro-Agent](semantic-router-micro-agent.md)。
