...
SkyRL × vLLM × Megatron。8×H100，Qwen3.5-35B-A3B 同步 DAPO：合同覆盖区域的平均 rollout–train logprob 差压到 **1e-6 以下**，相对当时 SkyRL 基线约 **25%** 墙钟。图在原网页。仓库：https://github.com/zanderjiang/SkyRL-IsoExec
