...
GLM-5.2 是 744B MoE、40B 激活，DSA 稀疏 attention，原生 MTP。vLLM 三样都已经会。工作是把它们和 P/D 收在一起，再围着 SLA 调参数、拓扑、调度。

## 2. 起点：P/D 下把 Decode 做快
...
Mean TPOT **约 40 ms → 约 22 ms**——整趟最大的一跳。
