...
How the names are computed: [design-metrics.md](design-metrics.md). Client stopwatches (AIPerf / `vllm bench serve`) live outside the door; `/metrics` lives inside. The two clocks can disagree — compare formulas, not the three letters “TTFT”.
